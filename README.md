...
| Ticket Capture Service      | Responsible for ticket creation and ticket updates. Shared between Clients and Support Staff. Client face critical service. The reasons of having serperate service are mentioned in [ADR0003](adrs/adr0003-modularization-ticket_processing.md) and [ARD0004](adrs/adr0004-customer-call-center-staff-modularization.md)     |
